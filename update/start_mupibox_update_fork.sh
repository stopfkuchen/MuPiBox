...
#https://raw.githubusercontent.com/#!/bin/bash
#
...
if [ "$FORK" = "stopfkuchen" ]; then
    GITHUB_USER="stopfkuchen"
else
    GITHUB_USER="splitti"
fi

#https://raw.githubusercontent.com/${GITHUB_USER}/MuPiBox/main
